// This file is vJoy's vjoyinterface.h, modified for use with Rust's bindgen tool.
// Changes:
//	* Windows types added
// 	* Fixed invalid C syntax
//	* "extern C" block removed
//	* union type hacked out
// When vJoy updates its vjoyinterface.h, consider running a diff between its old and new versions
// and manually updating this file accordingly.
...
typedef struct _FFB_EFF_REPORT {
	...
	BYTE		DirX; // hacked out the union here
